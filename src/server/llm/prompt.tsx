...
C) 给出 3 个“用户可点击的回击选项” retort_options（每条≤20字，必须是中文，风格各不相同，不越界）。
...
=========================
- 若 {{break_meter}} >= 100：
  - reply 必须表现“破防/投降”，承认失败（可以嘴硬但要输），仍为单句中文
  - damage_delta 固定输出 0
  - retort_options 仍输出 3 条，但改为“用户的终结嘲讽”（≤20字），更像补刀收尾
  - damage_reason 必须用 "break_meter>=100"
